...
import cshoe2 from "./images/women-onestar-2-300x225.jpg";
import cshoe3 from "./images/women-onestar-2-1-600x384.jpg";
import cshoe4 from "./images/women-onestar-2-2-600x384.jpg";
import cshoe5 from "./images/women-onestar-2-3-600x384.jpg";
...
const images = [cshoe2, cshoe3, cshoe4, cshoe5];
    ...
    return (
        <div className="shoeshow">
            <Zoom {...zoomOutProperties}>
                <img key={0} src={images[0]} className="shoeslide1"/>
...
function OneStar2(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "One Star Love The Progress";
            ...
            <div className="slideshoe">
                ...
                <div className="inforcs">
                    <div className="title-link">
                        ...
                        <div>/</div>
                        <Link to="/women/onestar" className="link-childs">OneStar</Link>
                    </div>
