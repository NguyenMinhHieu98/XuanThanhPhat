...
import cshoe2 from "./images/kid-4-1-600x384.jpg";
import cshoe3 from "./images/kid-4-2-600x384.jpg";
import cshoe4 from "./images/kid-4-3-600x384.jpg";
...
const images = [cshoe8, cshoe2, cshoe3, cshoe4];
                ...
                <div className="slide-shoeshow">
                    ...
                    <div className="slide-images">
                        <div className="img-row">
                            <img src={cshoe8} className="img-cshoe1"></img>
