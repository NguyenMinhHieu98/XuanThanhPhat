...
import cshoe2 from "./images/kid-1-1-600x384.jpg";
import cshoe3 from "./images/kid-1-2-600x384.jpg";
import cshoe4 from "./images/kid-1-3-600x384.jpg";
import cshoe5 from "./images/kid-1-4-600x384.jpg";
...
function ChildShoe1(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "Chuck Taylor All Star Creatures Boston x London Transport";
    let productPrice = "800,000đ";
