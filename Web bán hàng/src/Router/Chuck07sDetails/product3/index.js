...
import cshoe1 from "./images/women-classic-3-600x384.jpg";
import cshoe2 from "./images/women-chuck-07-3-600x384.jpg";
import cshoe3 from "./images/chuckClassicBlack1.jpg";
...
const slide1 = [cshoe4,  cshoe5, cshoe1, cshoe9, cshoe7];
...
function Chuck3(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "Chuck Taylor All Star 70 Pastel Leather";
    let productPrice = "1,900,000đ";
            ...
            <div className="slideshoe">
                ...
                <div className="inforcs">
                    <div className="title-link">
                        ...
                        <div>/</div>
                        <Link to="/women/chuck07s" className="link-childs">CHUCK 07S</Link>
                    </div>
