...
import cshoe1 from "./images/women-onestar-1-600x384.jpg";
import cshoe2 from "./images/women-onestar-1-1-600x384.jpg";
import cshoe3 from "./images/women-onestar-1-2-600x384.jpg";
import cshoe4 from "./images/women-onestar-1-3-600x384.jpg";
import cshoe5 from "./images/women-onestar-1-4-600x384.jpg";
...
const slide1 = [cshoe9, cshoe6, cshoe7, cshoe12, cshoe1];
const slide2 = [cshoe11, cshoe12, cshoe13, cshoe8, cshoe1];
            ...
            <div className="slideshoe">
                ...
                <div className="inforcs">
                    <div className="title-link">
                        ...
                        <div>/</div>
                        <Link to="/child" className="link-childs">Onestar</Link>
                    </div>
