...
import cshoe1 from "./images/chuckClassicBlack1.jpg";
import cshoe2 from "./images/women-chuck-07-2-600x384.jpg";
import cshoe3 from "./images/women-chuck-07-2-1-600x384.jpg";
import cshoe4 from "./images/women-chuck-07-2-2-600x384.jpg";
import cshoe5 from "./images/women-chuck-07-2-3-600x384.jpg";
import cshoe from "./images/women-chuck-07-2-4-600x384.jpg"
...
import cshoe9 from "./images/women-onestar-1-600x384.jpg";
import cshoe10 from "./images/women-sunbaked-1-600x384.jpg";
import cshoe11 from "./images/women-sunbaked-2-600x384.jpg";
import cshoe12 from "./images/women-sunbaked-3-600x384.jpg";
...
const images = [cshoe2, cshoe3, cshoe4, cshoe5, cshoe];

const slide1 = [cshoe1, cshoe6, cshoe7, cshoe11, cshoe9];
const slide2 = [cshoe10, cshoe11, cshoe12, cshoe8, cshoe9];
...
function Chuck4(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "Chuck Taylor All Star 70 Poplin Shirt";
            ...
            <div className="slideshoe">
                <div className="slide-shoeshow">
                    ...
                    <div className="slide-images">
                        <div className="img-row">
                            ...
                            <img src={cshoe5} className="img-cshoe1"></img>
                        </div>
                ...
                <div className="inforcs">
                    <div className="title-link">
                        ...
                        <div>/</div>
                        <Link to="/men" className="link-childs">Nam</Link>
                        <div>/</div>
                        <Link to="/accessories" className="link-childs">Accessory</Link>
                    </div>
