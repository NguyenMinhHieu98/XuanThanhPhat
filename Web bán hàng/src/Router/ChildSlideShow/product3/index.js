...
import cshoe2 from "./images/kid-3-1-600x384.jpg";
import cshoe3 from "./images/kid-3-2-600x384.jpg";
import cshoe4 from "./images/kid-3-3-600x384.jpg";
...
const images = [cshoe7, cshoe2, cshoe3, cshoe4];
                ...
                <div className="slide-shoeshow">
                    ...
                    <div className="slide-images">
                        <div className="img-row">
                            <img src={cshoe7} className="img-cshoe1"></img>
