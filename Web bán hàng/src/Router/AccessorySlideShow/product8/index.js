...
import cshoe1 from "./images/T-shirt-1-600x384.jpg";
import cshoe2 from "./images/T-shirt-2-600x384.jpg";
import cshoe3 from "./images/T-shirt-600x384.jpg";
import cshoe4 from "./images/balo-1-600x384.jpg";
import cshoe5 from "./images/balo-2-600x384.jpg";
import cshoe6 from "./images/balo-3-600x384.jpg";
import cshoe7 from "./images/balo-4-600x384.jpg";
import cshoe8 from "./images/jogger-600x384.jpg";
...
const slide2 = [cshoe6, cshoe7, cshoe8, cshoe1, cshoe3];
...
function Balo4(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "Poly Chuck Plus 1.0";
    let productPrice = "100,000đ";
            ...
            <div className="slideshoe">
                ...
                <div className="inforcs">
                    <div className="title-link">
                        ...
                        <div>/</div>
                        <Link to="/child" className="link-childs">Accessory</Link>
                    </div>
                    ...
                    <TabPanel value={value} index={1}>
                        <div className='product-rating'>
                            ...
                            >
                                ...
                                <div>
                                    <Typography component="legend" sx={{ margin: '1% 0', fontWeight: 'bold' }}>ĐÁNH GIÁ (0)</Typography>
                                    <p style={{ marginTop: '4%' }}>Chưa có đánh giá nào</p>
                                </div>
                            </Box>
                        </div>
                    </TabPanel>
