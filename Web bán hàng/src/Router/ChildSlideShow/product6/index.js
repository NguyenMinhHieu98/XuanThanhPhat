...
import cshoe2 from "./images/kid-6-1-600x384.jpg";
import cshoe3 from "./images/kid-6-2-600x384.jpg";
import cshoe4 from "./images/kid-6-3-600x384.jpg";
import cshoe5 from "./images/kid-6-4-600x384.jpg";
...
const images = [cshoe9, cshoe2, cshoe3, cshoe4, cshoe5];
...
function ChildShoe6(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "Chuck Taylor All Star Simple Step Watermelon";
                ...
                <div className="slide-shoeshow">
                    ...
                    <div className="slide-images">
                        <div className="img-row">
                            <img src={cshoe9} className="img-cshoe1"></img>
