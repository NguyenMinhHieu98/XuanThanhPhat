...
import product1 from "./images/women-sunbaked-1.jpg";
                ...
                <div className="rightdiv">
                    ...
                    <div className="productw">
                        <div className="productlu">
                            ...
                            <button className="productbtn"><Link to="/Cart/One-Star-Sunbaked-1" className="btn-link">THÊM VÀO GIỎ</Link></button>
                        </div>
                        <div className="productlu">
                            <img src={product2} className="productimg"></img>
                            <p className="productp1">One Star Sunbaked</p>
                            <p className="productp2">1,250,000</p>
                            <button className="productbtn"><Link to="/Cart/One-Star-Sunbaked-2" className="btn-link">THÊM VÀO GIỎ</Link></button>
                        </div>
                        <div className="productlu">
