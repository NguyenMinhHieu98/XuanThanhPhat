...
import cshoe1 from "./images/women-classic-8-600x384.jpg";
import cshoe2 from "./images/women-classic-8-1-600x384.jpg";
import cshoe3 from "./images/women-classic-8-2-600x384.jpg";
import cshoe from "./images/women-classic-8-3-600x384.jpg";
import cshoe4 from "./images/chuckClassicBlack1.jpg";
import cshoe5 from "./images/women-classic-2-600x384.jpg";
import cshoe6 from "./images/women-classic-3-600x384.jpg";
import cshoe7 from "./images/women-onestar-1-600x384.jpg";
import cshoe8 from "./images/women-sunbaked-1-600x384.jpg";
import cshoe9 from "./images/women-sunbaked-2-600x384.jpg";
import cshoe10 from "./images/women-sunbaked-3-600x384.jpg";
import cshoe11 from "./images/women-classic-4-600x384.jpg";
...
const images = [cshoe2, cshoe3, cshoe1, cshoe];

const slide1 = [cshoe4,  cshoe5, cshoe6, cshoe9, cshoe7];
const slide2 = [cshoe8, cshoe9, cshoe10, cshoe11, cshoe7];
...
function Classic8(props) {
    // Chứa giá trị trong biến để tiện đẩy lên database
    let productName = "Chuck Taylor Classic";
    let productPrice = "1,250,000đ";
            ...
            <div className="slideshoe">
                <div className="slide-shoeshow">
                    ...
                    <div className="slide-images">
                        <div className="img-row">
                            ...
                            <img src={cshoe} className="img-cshoe1"></img>
                        </div>
                    </div>
                </div>
                <div className="inforcs">
                    <div className="title-link">
                        ...
                        <div>/</div>
                        <Link to="/infor" className="link-childs">Classic</Link>
                    </div>
